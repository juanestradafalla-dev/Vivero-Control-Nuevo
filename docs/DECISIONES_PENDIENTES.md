...
|---:|---|---|
| 1 | RESUELTA | Vivero Maestro será una aplicación para Windows. La tecnología concreta continúa en la decisión 2. |
...
Antes de cerrar definitivamente la Etapa 1 se necesita recibir:
...
2. **Tecnología de Vivero Maestro:** definir framework, distribución, actualizaciones y funcionamiento ante pérdida de conexión dentro de Windows.
