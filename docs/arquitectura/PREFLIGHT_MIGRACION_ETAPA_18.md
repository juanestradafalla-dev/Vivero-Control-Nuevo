...
El validador aplica estructura estricta, tamaño y cantidades máximas, claves y códigos únicos, referencias, ciclos, enteros seguros, suma segura, fuente trazable de al menos tres caracteres y detección defensiva de secretos. Toda línea activa debe incluir exactamente un inventario inicial. El total cero permanece bloqueado salvo que el paquete marque explícitamente `lineaVaciaConfirmada: true`; esa excepción controlada genera una advertencia y una cantidad positiva con la misma marca se rechaza.
